  ...
  return (
    <View style={{ height: 50, flexDirection: "row" }}>
      <View style={{ flex: 4, width: "100%", justifyContent: "center" }}>
        <Text style={{ fontFamily: "Mada-Black", color: "#7D7D7D" }}>
          {title}
        </Text>
      </View>
      ...
      >
        <Pressable onPress={() => setEdit(title)}>
          <Text
            numberOfLines={1}
            style={{ fontFamily: "Mada-Black", color: "#4F4F4F" }}
          >
            {data}
          </Text>
          <DataLine />
        ...
        <View style={{ flex: 10, flexDirection: "row" }}>
          ...
          <View style={{ flex: 10, flexDirection: "column", marginTop: 20 }}>
            ...
            <DataRow
              title="Website"
              setEdit={updateEdit}
              data={profileData.website.href}
            />
            <DataRow
              title="Tags"
              setEdit={updateEdit}
              data={profileData.tags.reduce((acc, curr) => `${acc}, ${curr}`)}
            />
            <DataRow
              title="About Us"
              setEdit={updateEdit}
              data={profileData.aboutUs}
            />
          </View>
          <Margin />
        </View>
